...
income and spending information to better control, manage and plan out their flow of money.
...
these fields, see <<../UserGuide.adoc#TransactionDetailsTag, here>>.
...
The *clone* functionality is facilitated by common <<../DeveloperGuide.adoc#Design-Logic, *Logic*>> operations and classes for commands, with
